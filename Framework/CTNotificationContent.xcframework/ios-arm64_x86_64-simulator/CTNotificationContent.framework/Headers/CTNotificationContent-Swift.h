...
#ifndef CTNOTIFICATIONCONTENT_SWIFT_H
#define CTNOTIFICATIONCONTENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CTNotificationContent",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21CTNotificationContent20CTCaptionedImageView")
...
@interface CTCarouselController : BaseCTNotificationContentViewController
@property (nonatomic, copy) NSString * _Nonnull data;
@property (nonatomic, copy) NSString * _Nonnull templateType;
...
SWIFT_CLASS("_TtC21CTNotificationContent25CTContentSliderController")
